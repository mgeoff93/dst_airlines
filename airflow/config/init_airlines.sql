...
CREATE INDEX idx_dynamic_callsign_update ON flight_dynamic(callsign, last_update DESC);
...
CREATE TABLE IF NOT EXISTS live_data (
    ...
    CONSTRAINT pk_live_data PRIMARY KEY (request_id, flight_id),
    CONSTRAINT fk_live_dynamic FOREIGN KEY(flight_id) REFERENCES flight_dynamic(flight_id)
);

CREATE INDEX idx_live_flight_time ON live_data(flight_id);
