...
CREATE TEMP TABLE temp_countries (
    ...
    embassy TEXT,
    arab_world TEXT,
    central_europe_and_the_baltics TEXT,
    east_asia_pacific TEXT,
    euro_area TEXT,
    europe_central_asia TEXT,
    european_union TEXT,
    high_income TEXT,
    latin_america_caribbean TEXT,
    low_income TEXT,
    lower_middle_income TEXT,
    middle_east_north_africa TEXT,
    north_america TEXT,
    oecd_members TEXT,
    sub_saharan_africa TEXT,
    upper_middle_income TEXT,
    world TEXT,
    link TEXT,
    website TEXT,
    south_america TEXT,
    central_america_caraibes TEXT,
    continental_europe TEXT,
    asia_oceania TEXT,
    cocac TEXT,
    cf_mobility TEXT,
    idpaysage TEXT,
...
SELECT name_en, iso2 FROM temp_countries;
