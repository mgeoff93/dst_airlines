...
class PostgresClient:
	...
	def get_latest_dynamic_flight(self, callsign, icao24):
		...
		# Créer unique_key au format string
		dynamic["unique_key"] = f"{dynamic['callsign']}_{dynamic['icao24']}_{dynamic['flight_date']}_{dynamic['departure_scheduled'].strftime('%H:%M')}"
